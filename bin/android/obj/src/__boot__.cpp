...
::openfl::_v2::utils::Timer_obj::__register();
...
::com::nog::game::vo::Infos_obj::__register();
::com::nog::game::view::player::PlayerPowers_obj::__register();
::com::nog::game::view::player::PlayerMatter_obj::__register();
::com::nog::game::view::player::PlayerInfo_obj::__register();
::com::nog::game::view::player::PlayerGameView_obj::__register();
::com::nog::game::view::player::PlayerFace_obj::__register();
::com::nog::game::view::Tile_obj::__register();
::com::nog::game::view::SmallGrid_obj::__register();
::com::nog::game::view::Grid_obj::__register();
::com::nog::game::view::GameBoard_obj::__register();
::com::nog::game::utils::BezierArc_obj::__register();
::com::nog::game::model::Player_obj::__register();
::com::nog::game::model::GridData_obj::__register();
::com::nog::game::model::GameCore_obj::__register();
::com::nog::game::Game_obj::__register();
::Type_obj::__register();
...
::Type_obj::__boot();
::com::nog::game::Game_obj::__boot();
::com::nog::game::model::GameCore_obj::__boot();
::com::nog::game::model::GridData_obj::__boot();
::com::nog::game::model::Player_obj::__boot();
::com::nog::game::utils::BezierArc_obj::__boot();
::com::nog::game::view::GameBoard_obj::__boot();
::com::nog::game::view::Grid_obj::__boot();
::com::nog::game::view::SmallGrid_obj::__boot();
::com::nog::game::view::Tile_obj::__boot();
::com::nog::game::view::player::PlayerFace_obj::__boot();
::com::nog::game::view::player::PlayerGameView_obj::__boot();
::com::nog::game::view::player::PlayerInfo_obj::__boot();
::com::nog::game::view::player::PlayerMatter_obj::__boot();
::com::nog::game::view::player::PlayerPowers_obj::__boot();
::com::nog::game::vo::Infos_obj::__boot();
...
::openfl::_v2::utils::Timer_obj::__boot();
