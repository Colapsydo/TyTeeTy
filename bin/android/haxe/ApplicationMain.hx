...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Colapsydo", "TTT", "com.nog.TTT", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.nog.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.nog.Main, Reflect.field (com.nog.Main, "main"), []);
...
@:keep class DocumentClass extends com.nog.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TTT", null, { width: 0, height: 0 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.nog.Main, []);
			}
